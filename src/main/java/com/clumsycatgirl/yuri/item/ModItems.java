...
import com.clumsycatgirl.yuri.item.custom.ChiselItem;
...
public class ModItems {
	...
	public static final DeferredItem<Item> BROOM = ITEMS.register("broom", () -> new Item(new Item.Properties()));

	public static final DeferredItem<RandomPickerItem> RANDOM_PICKER = ITEMS.register("random_picker", () -> new RandomPickerItem(new Item.Properties().stacksTo(1)));
